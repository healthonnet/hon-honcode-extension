...
var hon_md5 =
{
  ...
  hex_hmac_md5: function(key, data) {
    return this.binl2hex(this.coreHmac_md5(key, data));
  },

  b64_hmac_md5: function(key, data) {
    return this.binl2b64(this.coreHmac_md5(key, data));
  },

  str_hmac_md5: function(key, data) {
    return this.binl2str(this.coreHmac_md5(key, data));
  },
  ...
  core_hmac_md5: function(key, data) {
    ...
    if (bkey.length > 16) {
      bkey = core_md5(bkey, key.length * this.chrsz);
    }
